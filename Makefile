...
# Template: app
# Command: C:\Qt\Qt5.8.0\5.8\mingw53_32\bin\qmake.exe -o Makefile Backend_CTSK_Qt650_test.pro -spec win32-g++ "CONFIG+=debug"
#############################################################################
...
Makefile: Backend_CTSK_Qt650_test.pro C:/Qt/Qt5.8.0/5.8/mingw53_32/mkspecs/win32-g++/qmake.conf C:/Qt/Qt5.8.0/5.8/mingw53_32/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile Backend_CTSK_Qt650_test.pro -spec win32-g++ "CONFIG+=debug"
